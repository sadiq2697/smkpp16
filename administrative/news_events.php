...
echo $buffer;
//
$query = query("SELECT `blog_id`, `title`, `image`, `description`,sort, `liked`, `viewed`, `date` FROM `news_events` WHERE 1");
?>
        <!-- Navigation Bar-->
											...
											<table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer  responsive">
												...
												?>
													<tr>
														...
														<td><img src="../images/news_events/<?php echo $image?>" width="70px" alt="<?php echo $sort?>" /></td>										
														...
														<div class="btn-group">
															...
															<ul class="dropdown-menu drop-menu-right" role="menu">
																...
																<li><a onclick="return confirm('Are you sure want to delete')" href="functions/news_events.php?do=delete&id=<?php echo $blog_id?>"><i class="fa fa-trash-o fa-fw"></i> Delete</a></li>
															</ul>
														</div>
														</td>
													</tr>
...
<form role="form" class="form-horizontal" method="post" action="functions/news_events.php?do=add" enctype="multipart/form-data">
...
function edit(id)
{
	$.ajax({
		type:'post',
		url:'functions/news_events.php?do=edit',
		data:'id='+id,
