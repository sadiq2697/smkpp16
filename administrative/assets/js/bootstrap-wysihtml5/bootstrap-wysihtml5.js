!function($, wysi) {
            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "<div class='modal-body'>" +
                  "<input type='text' value='http://' class='bootstrap-wysihtml5-insert-link-url form-control large'>" +
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["assets/js/bootstrap-wysihtml5/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
