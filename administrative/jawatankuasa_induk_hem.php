...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/hem.php?do=jawatankuasa_induk_hem" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Jawatankuasa Induk HEM</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="jawatankuasa_induk_hem" class="summernote" >
                                   	
                               <?php 
                                $jawatankuasa_induk_hem_query=query("SELECT jawatankuasa_induk_hem from hem");
                                $jawatankuasa_induk_hemrow = $jawatankuasa_induk_hem_query->row;
                                $content = $jawatankuasa_induk_hemrow["jawatankuasa_induk_hem"];
                                echo $content;
                                ?>
