...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/kokurikulum.php?do=unit_beruniform" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Unit Beruniform</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="unit_beruniform" class="summernote" >
                                   	
                               <?php 
                                $unit_beruniform_query=query("SELECT unit_beruniform from kokurikulum");
                                $unit_beruniformrow = $unit_beruniform_query->row;
                                $content = $unit_beruniformrow["unit_beruniform"];
                                echo $content;
                                ?>
