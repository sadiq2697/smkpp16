...
ob_end_clean();
$title = "Bidang Teknik & Vokasional";
...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/akademik.php?do=bidang_teknik_vokasional" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Bidang Teknik & Vokasional</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="bidang_teknik_vokasional" class="summernote" >
                                   	
                               <?php 
                                $bidang_teknik_vokasional_query=query("SELECT bidang_teknik_vokasional from akademik");
                                $bidang_teknik_vokasionalrow = $bidang_teknik_vokasional_query->row;
                                $content = $bidang_teknik_vokasionalrow["bidang_teknik_vokasional"];
                                echo $content;
                                ?>
