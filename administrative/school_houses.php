...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/syllabi_curricula.php?do=school_houses" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> School Houses</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="school_houses" class="summernote" >
                                   	
                               <?php 
                                $about_query=query("SELECT school_houses from syllabi_curricula");
                                $aboutrow = $about_query->row;
                                $content = $aboutrow["school_houses"];
                                echo $content;
                                ?>
