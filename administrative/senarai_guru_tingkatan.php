...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/hem.php?do=senarai_guru_tingkatan" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> JSenarai Guru Tingkatan</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="senarai_guru_tingkatan" class="summernote" >
                                   	
                               <?php 
                                $senarai_guru_tingkatan_query=query("SELECT senarai_guru_tingkatan from hem");
                                $senarai_guru_tingkatanrow = $senarai_guru_tingkatan_query->row;
                                $content = $senarai_guru_tingkatanrow["senarai_guru_tingkatan"];
                                echo $content;
                                ?>
