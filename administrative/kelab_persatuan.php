...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/kokurikulum.php?do=kelab_persatuan" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Kelab & Persatuan</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="kelab_persatuan" class="summernote" >
                                   	
                               <?php 
                                $kelab_persatuan_query=query("SELECT kelab_persatuan from kokurikulum");
                                $kelab_persatuanrow = $kelab_persatuan_query->row;
                                $content = $kelab_persatuanrow["kelab_persatuan"];
                                echo $content;
                                ?>
