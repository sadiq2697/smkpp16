...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/kokurikulum.php?do=jk_induk_kokurikulum" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="jk_induk_kokurikulum" class="summernote" >
                                   	
                               <?php 
                                $jk_induk_kokurikulum_query=query("SELECT jk_induk_kokurikulum from kokurikulum");
                                $jk_induk_kokurikulumrow = $jk_induk_kokurikulum_query->row;
                                $content = $jk_induk_kokurikulumrow["jk_induk_kokurikulum"];
                                echo $content;
                                ?>
