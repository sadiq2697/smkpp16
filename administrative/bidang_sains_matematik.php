...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/akademik.php?do=bidang_sains_matematik" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Bidang Sains & Matematik</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="bidang_sains_matematik" class="summernote" >
                                   	
                               <?php 
                                $bidang_sains_matematik_query=query("SELECT bidang_sains_matematik from akademik");
                                $bidang_sains_matematikrow = $bidang_sains_matematik_query->row;
                                $content = $bidang_sains_matematikrow["bidang_sains_matematik"];
                                echo $content;
                                ?>
