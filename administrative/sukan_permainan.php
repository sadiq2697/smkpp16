...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/kokurikulum.php?do=sukan_permainan" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Sukan & Permainan</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="sukan_permainan" class="summernote" >
                                   	
                               <?php 
                                $sukan_permainan_query=query("SELECT sukan_permainan from kokurikulum");
                                $sukan_permainanrow = $sukan_permainan_query->row;
                                $content = $sukan_permainanrow["sukan_permainan"];
                                echo $content;
                                ?>
