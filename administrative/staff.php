...
echo $buffer;
//
$query = query("SELECT * FROM `staff` WHERE 1");
?>
        <!-- Navigation Bar-->
											...
											<table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer  responsive">
												...
												?>
													<tr>
														...
														<td><img src="../images/staff/<?php echo $image?>" width="70px" alt="<?php echo $name?>" /></td>	
														<td><?php echo $name?></td>
														...
														<div class="btn-group">
															...
															<ul class="dropdown-menu drop-menu-right" role="menu">
																<li><a onclick="edit('<?php echo $staff_id?>')" class="edit" href="#edit" data-toggle="modal"><i class="fa fa-pencil fa-fw"></i> Edit</a></li>
																<li><a onclick="return confirm('Are you sure want to delete')" href="functions/staff.php?do=delete&id=<?php echo $staff_id?>"><i class="fa fa-trash-o fa-fw"></i> Delete</a></li>
															</ul>
														</div>
														</td>
													</tr>
...
<form role="form" class="form-horizontal" method="post" action="functions/staff.php?do=add" enctype="multipart/form-data">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
<h4 class="modal-title">Add Staf Sokongan</h4>
</div>
...
function edit(id)
{
	$.ajax({
		type:'post',
		url:'functions/staff.php?do=edit',
		data:'id='+id,
