...
ob_end_clean();
$title = "Alumini Corner";
$buffer = preg_replace('/(<title>)(.*?)(<\/title>)/i', '$1' . $title . '$3', $buffer);
echo $buffer;
//
$query = query("SELECT * FROM `alumini_corner` WHERE 1");
?>
        <!-- Navigation Bar-->
									...
									<div class="portlet-body">
										<div class="">
											<table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer  responsive">
												...
												{
													$alumini_corner_id= $rows["alumini_corner_id"];
													$image= $rows["image"];
													$name= $rows["name"];
												...
												?>
													<tr>
														...
														<td><img src="../images/alumini_corner/<?php echo $image?>" width="70px" alt="<?php echo $name?>" /></td>	
														<td><?php echo $name?></td>
														...
														<div class="btn-group">
															...
															<ul class="dropdown-menu drop-menu-right" role="menu">
																<li><a onclick="edit('<?php echo $alumini_corner_id?>')" class="edit" href="#edit" data-toggle="modal"><i class="fa fa-pencil fa-fw"></i> Edit</a></li>
																<li><a onclick="return confirm('Are you sure want to delete')" href="functions/alumini_corner.php?do=delete&id=<?php echo $alumini_corner_id?>"><i class="fa fa-trash-o fa-fw"></i> Delete</a></li>
															</ul>
														</div>
														</td>
													</tr>
...
<form role="form" class="form-horizontal" method="post" action="functions/alumini_corner.php?do=add" enctype="multipart/form-data">
...
function edit(id)
{
	$.ajax({
		type:'post',
		url:'functions/alumini_corner.php?do=edit',
		data:'id='+id,
