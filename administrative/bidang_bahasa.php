...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/akademik.php?do=bidang_bahasa" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Bidang Bahasa</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="bidang_bahasa" class="summernote" >
                                   	
                               <?php 
                                $bidang_bahasa_query=query("SELECT bidang_bahasa from akademik");
                                $bidang_bahasarow = $bidang_bahasa_query->row;
                                $content = $bidang_bahasarow["bidang_bahasa"];
                                echo $content;
                                ?>
