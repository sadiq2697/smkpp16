...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/school_structure.php?do=academic_year" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Academic Year</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="academic_year" class="summernote" >
                                   	
                               <?php 
                                $about_query=query("SELECT academic_year from school_structure");
                                $aboutrow = $about_query->row;
                                $content = $aboutrow["academic_year"];
                                echo $content;
                                ?>
