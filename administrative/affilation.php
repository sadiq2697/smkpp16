...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/affilation.php?do=affilation" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Affilation</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="affilation" class="summernote" >
                                   	
                               <?php 
                                $about_query=query("SELECT affilation from affilation");
                                $aboutrow = $about_query->row;
                                $content = $aboutrow["affilation"];
                                echo $content;
                                ?>
