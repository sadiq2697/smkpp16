...
?>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                        ...
                        <div class="row">
<form id="upform" action="functions/akademik.php?do=bidang_kemanusiaan" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <h4 class="pull-left"><span class="fa fa-plus"></span> Bidang Kemanusiaan</h4>
                                ...
                                <div class="panel-body form-group-separated">
                                   ...
                                   <textarea name="bidang_kemanusiaan" class="summernote" >
                                   	
                               <?php 
                                $bidang_kemanusiaan_query=query("SELECT bidang_kemanusiaan from akademik");
                                $bidang_kemanusiaanrow = $bidang_kemanusiaan_query->row;
                                $content = $bidang_kemanusiaanrow["bidang_kemanusiaan"];
                                echo $content;
                                ?>
